...
Prefer the ESP32-C6 (DFR1075) however which is the only one that supports active battery level monitoring which will be reported back to your host. The other two will only report a dummy 100% battery.
